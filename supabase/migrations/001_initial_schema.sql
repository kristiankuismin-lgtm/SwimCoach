...
CREATE EXTENSION IF NOT EXISTS "pgvector"; -- AI-embedding-hakuja varten
...
CREATE TABLE competition_results (
  ...
  time_diff_ms    INT GENERATED ALWAYS AS (
    result_time_ms - COALESCE((
      SELECT target_time_ms FROM yearly_goals WHERE id = goal_id
    ), result_time_ms)
  ) STORED,
